            ...
            child: DecoratedColumn(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final centerLatLng = await _controller.getCenterCoordinate();
                    final screenPoint = await _controller?.toScreenLocation(centerLatLng);
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    final latLng = await _controller?.fromScreenLocation(screenPoint);
...
//                    await _controller?.setPointToCenter(screenPoint);
                ...
                ListTile(
                  ...
                  onTap: () async {
                    await _controller?.setMyLocationChangeListener((location) async {
